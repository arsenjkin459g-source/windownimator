...
- **Горячие клавиши удаления (`Delete` / `Backspace`)**: Быстрое удаление выделенных окон.
...
- **Иконка приложения**: Нативная интеграция `windownimator.ico` в заголовки окон и панель задач Windows.
...
- Убран ложный всплывающий диалог *«Сохранить текущие изменения?»* при первом старте.
- Удалены смайлики и эмодзи из текста стартовых диалогов.
